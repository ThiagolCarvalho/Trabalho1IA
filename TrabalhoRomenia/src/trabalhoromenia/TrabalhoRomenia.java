...
public class TrabalhoRomenia implements Problema {
	...
	/* Construtor */
	public TrabalhoRomenia(String nomeEstadoInicial, String nomeObjetivo) {
		inicializarProblema();
	...
	public static void main(String[] args) {
		...
		Problema problema = new TrabalhoRomenia("Arad", "Bucareste");
		...
		agente.buscar(problema, "LArgura", "Largura");
                ...
                BuscaEmProfundidade agente2 = new BuscaEmProfundidade();
                ...
                BuscaAprofundamento agente3 = new BuscaAprofundamento();
